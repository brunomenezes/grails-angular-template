class GrailsAngularTemplateGrailsPlugin {
    ...
    def description = "The best way to load GSP templates with angular build-in structures, using the steady Grails mechanism of template load.'
    ...
    def scm = [ url: "https://github.com/brunomenezes/grails-angular-template" ]
}
